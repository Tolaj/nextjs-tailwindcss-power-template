...
const MyCompButton = (params) => {
  const ActionAlumniData = async (data)=>{
          await axios.delete(process.env.SERVER_API+"api/newsletter", {data})
          .then((rowData) => {
...
export default function NewsLetters(props)  {
    ...
    const [columnDefs, setColumnDefs] = useState([
        // {headerName:'SR.No.',field: '', filter: false,cellRenderer:(params)=>{console.log(params)}},
        {headerName:'EMAIL ADDRESSES',field: 'email', filter: true},
