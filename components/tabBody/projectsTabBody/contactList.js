...
//           await axios.delete(process.env.SERVER_API+"api/contact", {data})
//           .then((rowData) => {
...
export default function ContactList(props)  {
    ...
    const [columnDefs, setColumnDefs] = useState([
        ...
        {headerName:'Action',field: 'accountStatus', filter: false}, 
    ]);
    ...
    const defaultColDef = useMemo(() => {
       ...
       // Example load data from server
        ...
        //     await axios.get(`${process.env.SERVER_API}api/contact`,{
        //         headers: {
        //           'Authorization': token
        //         },
        //       })
